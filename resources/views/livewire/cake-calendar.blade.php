            ...
            <table class="table-fixed w-full">
                ...
                @if($cakeEvents)
                    @foreach ($cakeEvents as $event)
                        <tr>
                            <td class="border px-4 py-2 w-48 text-center">{{$event['date']}}</td>
                            <td class="border px-4 py-2 text-center">{{$event['small_cake']}}</td>
                            <td class="border px-4 py-2 text-center">{{$event['large_cake']}}</td>
                            <td class="border px-4 py-2 text-center">{{implode(',',$event['developers'])}}</td>
                        </tr>
                    @endforeach
                @endif
                </tbody>
